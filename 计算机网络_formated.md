...
![CSMACD协议.png](figures/CSMACD协议.png)
...
![v2MAC数据帧格式.png](figures/v2MAC数据帧格式.png)
##### 数据链路层部分
...
- IGMP协议用于实现IP组播
![IP数据报格式.png](figures/IP数据报格式.png)
...
- 工作过程
	...
	- 服务器 $\displaystyle \to$ 客户：DHCP确认报文
		- 和DHCP提供报文类似
![DHCP协议工作过程.png](figures/DHCP协议工作过程.png)
## 4.3 ICMP协议 网际控制报文协议
ICMP协议是为了更加有效地转发IP数据报和提高交付成功的机会
![ICMP格式.png](figures/ICMP格式.png)
### 4.3.1 ICMP差错报文
...
![ICMP重定向工作原理.png](figures/ICMP重定向工作原理.png)
---
- 四种不发送ICMP差错报文的情况
...
## 4.4 IPv6
从根本上解决IP地址耗尽问题
![IPv6格式.png](figures/IPv6格式.png)

![IPv6格式详细版.png](figures/IPv6格式详细版.png)
- IPv6基本首部 40B
	- 版本：指明协议版本，总是6
	- 优先级：区分数据报的类别和优先级
...
![五种数据报传输形式.png](figures/五种数据报传输形式.png)
