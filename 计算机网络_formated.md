...
![Round-Trip Time.png](Round-Trip Time.png)
$$
\begin{align}
往返时延&=数据的单向传播时延\\
&+接受方收到数据后的处理时延\\
...
- 确认帧长度 = 1kb
- 信道单向传播时延 = 7s
![GBN、SR协议的信道利用率.png](GBN、SR协议的信道利用率.png)
...
![GBN、SR协议信道利用率满的情况.png](GBN、SR协议信道利用率满的情况.png)
